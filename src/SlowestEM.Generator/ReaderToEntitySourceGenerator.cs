...
namespace SlowestEM.Generator
{
    ...
    public class ReaderToEntitySourceGenerator : ISourceGenerator
    {
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            {
                if (namedType.IsAbstract || namedType.IsGenericType || namedType.IsStatic || namedType.DeclaredAccessibility != Accessibility.Public)
                    continue;
        ...
        private void GenerateClassMapper(GeneratorExecutionContext context, StringBuilder cList, INamedTypeSymbol namedType)
        {
            ...
            var sss = GenerateRead(ps, fullName, namedType);
...
"; 
        ...
        private static void GenerateEnableFunc(GeneratorExecutionContext context, StringBuilder cList)
        {
            ...
            try
            {
                var hash = (Func<string, int>)typeof(string).GetMethod("GetNonRandomizedHashCodeOrdinalIgnoreCase", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance).CreateDelegate(typeof(Func<string, int>));
            }
            catch (Exception ex)
            {
                //s = ex.ToString();
